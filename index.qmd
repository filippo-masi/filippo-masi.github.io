...
I am a research scientist at the [Inria Centre at Université Grenoble Alpes](https://www.inria.fr/en/centre-inria-universite-grenoble-alpes), in the [TRIPOP](https://team.inria.fr/tripop/) team.

::: {.institution-logos}
[![Inria](images/logos/inria.svg){.institution-logo .inria-logo}](https://www.inria.fr/en/centre-inria-universite-grenoble-alpes) 
[![MIAI Cluster](images/logos/miai.svg){.institution-logo .miai-logo}](https://miai-cluster.univ-grenoble-alpes.fr/english/)
...
I develop discrete- and finite-element simulations, machine-learning methods, constitutive models and thermodynamics-based approaches. My activities concern dissipative and nonlinear phenomena such as plasticity, fracture, friction and impacts, with particular interest in fast dynamics.
